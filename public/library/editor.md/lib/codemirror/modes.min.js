...
!function (e) {
    ...
    e.defineMode("css", function (t, r) {
        ...
        var m, h, p = t.indentUnit, g = r.tokenHooks, v = r.documentTypes || {}, b = r.mediaTypes || {},
            y = r.mediaFeatures || {}, x = r.propertyKeywords || {}, k = r.nonStandardPropertyKeywords || {},
            w = r.fontProperties || {}, _ = r.counterDescriptors || {}, C = r.colorKeywords || {},
            S = r.valueKeywords || {}, T = r.allowNested, M = {};
        return M.top = function (e, t, r) {
            ...
            if ("hash" != e || /^#([0-9a-fA-f]{3}|[0-9a-fA-f]{6})$/.test(t.current())) {
                if ("word" == e) f(t); else if ("interpolation" == e) return l(r, t, "interpolation")
            } else h += " error";
            return "prop"
            ...
            startState: function (e) {
                return {tokenize: null, state: "top", stateArg: null, context: new s("top", e || 0, null)}
            }, token: function (e, t) {
    ...
    var i = ["domain", "regexp", "url", "url-prefix"], o = t(i),
        a = ["all", "aural", "braille", "handheld", "print", "projection", "screen", "tty", "tv", "embossed"], s = t(a),
        ...
        k = t(x), w = i.concat(a).concat(l).concat(u).concat(f).concat(b).concat(x);
    ...
    e.defineMode("sass", function (e) {
        ...
        function i(e, t) {
            function r(n, i) {
                var a = n.next(), s = n.peek(), c = n.string.charAt(n.pos - 2),
                    u = "\\" !== a && s === e || a === e && "\\" !== c;
        ...
        function a(t) {
            if (0 == t.indentCount) {
                t.indentCount++;
                var r = t.scopes[0].offset, n = r + e.indentUnit;
        ...
        function c(t, r) {
            ...
            var n = r.tokenizer(t, r), i = t.current();
        ...
        var u = ["true", "false", "null", "auto"], d = new RegExp("^" + u.join("|")),
            f = ["\\(", "\\)", "=", ">", "<", "==", ">=", "<=", "\\+", "-", "\\!=", "/", "\\*", "%", "and", "or", "not", ";", "\\{", "\\}", ":"],
            m = t(f), h = /^::?[a-zA-Z_][\w\-]*/;
        return {
            startState: function () {
    ...
    e.defineMode("sql", function (t, r) {
        ...
        var l = r.client || {}, c = r.atoms || {"false": !0, "true": !0, "null": !0}, u = r.builtin || {},
            d = r.keywords || {}, f = r.operatorChars || /^[*+\-%<>!=&|~^]/, m = r.support || {}, h = r.hooks || {},
    ...
    function o(e, t) {
        var r = t.cpp11RawStringDelim.replace(/[^\w\s]/g, "\\$&"), n = e.match(new RegExp(".*?\\)" + r + '"'));
    ...
    e.defineMode("clike", function (t, r) {
        ...
        var c, u = t.indentUnit, d = r.statementIndentUnit || u, f = r.dontAlignCalls, m = r.keywords || {},
            h = r.builtin || {}, p = r.blockKeywords || {}, g = r.atoms || {}, v = r.hooks || {},
            b = r.multiLineStrings, y = r.indentStatements !== !1, x = /[+\-*&%=<>!?|\/]/;
        return {
            startState: function (e) {
                ...
                if (null == r.align && (r.align = !0), ";" != c && ":" != c && "," != c || "statement" != r.type) if ("{" == c) s(t, e.column(), "}"); else if ("[" == c) s(t, e.column(), "]"); else if ("(" == c) s(t, e.column(), ")"); else if ("}" == c) {
                    for (; "statement" == r.type;) r = l(t);
                    for ("}" == r.type && (r = l(t)); "statement" == r.type;) r = l(t)
                } else c == r.type ? l(t) : y && (("}" == r.type || "top" == r.type) && ";" != c || "statement" == r.type && "newstatement" == c) && s(t, e.column(), "statement"); else l(t);
    ...
    function r(e, t) {
        return 0 == e.length ? n(t) : function (i, o) {
            for (var a = e[0], s = 0; s < a.length; s++) if (i.match(a[s][0])) return o.tokenize = r(e.slice(1), t), a[s][1];
    ...
    function i(e, t, n) {
        ...
        if (e.match(/^\$[a-zA-Z_][a-zA-Z0-9_]*/)) return e.match("[", !1) && (t.tokenize = r([[["[", null]], [[/\d[\w\.]*/, "number"], [/\$[a-zA-Z_][a-zA-Z0-9_]*/, "variable-2"], [/[\w\$]+/, "variable"]], [["]", null]]], n)), e.match(/\-\>\w/, !1) && (t.tokenize = r([[["->", null]], [[/[\w]+/, "variable"]]], n)), "variable-2";
    ...
    e.defineMode("php", function (t, r) {
        ...
        return {
            startState: function () {
                var t = e.startState(i), n = e.startState(o);
                return {html: t, php: n, curMode: r.startOpen ? o : i, curState: r.startOpen ? n : t, pending: null}
            }, copyState: function (t) {
                var r, n = t.html, a = e.copyState(i, n), s = t.php, l = e.copyState(o, s);
    ...
    e.defineMode("xml", function (t, r) {
        ...
        var x = t.indentUnit, k = r.multilineTagIndentFactor || 1, w = r.multilineTagIndentPastTag;
        null == w && (w = !0);
        ...
        return {
            startState: function () {
                return {tokenize: n, state: d, indented: 0, tagName: null, tagStart: null, context: null}
            },
            token: function (e, t) {
    ...
    e.defineMode("markdown", function (t, r) {
        ...
        var k = e.modes.hasOwnProperty("xml"), w = e.getMode(t, k ? {name: "xml", htmlMode: !0} : "text/plain");
        ...
        var _ = 0, C = "header", S = "comment", T = "quote", M = "variable-2", L = "variable-3", E = "keyword",
            q = "hr", j = "tag", z = "formatting", I = "link", P = "link", D = "link", A = "string", $ = "em",
            O = "strong", R = "strikethrough", F = /^([*\-=_])(?:\s*\1){2,}\s*$/, H = /^[*\-+]\s+/, N = /^[0-9]+\.\s+/,
            B = /^\[(x| )\](?=\s)/, U = /^#+/, W = /^(?:\={1,}|-{1,})$/, V = /^[^#!\[\]*_\\<>` "'(~]+/, K = [], Z = {
                startState: function () {
                    return {
                        f: s,
                    ...
                    return e.block == l ? {state: e.htmlState, mode: w} : e.localState ? {
                        state: e.localState,
                        mode: e.localMode
                    } : {state: e, mode: Z}
    ...
    e.defineMode("javascript", function (t, r) {
        ...
        function o(e, t) {
            ...
            if (we.test(r)) {
                e.eatWhile(we);
                var o = e.current(), c = _e.propertyIsEnumerable(o) && _e[o];
        ...
        function c(e, t) {
            ...
            if (!(0 > r)) {
                for (var n = 0, i = !1, o = r - 1; o >= 0; --o) {
                    var a = e.string.charAt(o), s = Te.indexOf(a);
                    if (s >= 0 && 3 > s) {
                        if (!n) {
                            ++o;
                            break
                        ...
                        if (0 == --n) break
                    } else if (s >= 3 && 6 > s) ++n; else if (we.test(a)) i = !0; else {
                        if (/["'\/]/.test(a)) return;
                        if (i && !n) {
                            ++o;
                            break
        ...
        function g() {
            Le.state.context = {prev: Le.state.context, vars: Le.state.localVars}, Le.state.localVars = Ee
        }
        ...
        var pe, ge, ve = t.indentUnit, be = r.statementIndent, ye = r.jsonld, xe = r.json || ye, ke = r.typescript,
            we = r.wordCharacters || /[\w$\xa1-\uffff]/, _e = function () {
                function e(e) {
                    return {type: e, style: "keyword"}
                }

                var t = e("keyword a"), r = e("keyword b"), n = e("keyword c"), i = e("operator"),
            ...
            Se = /^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/, Te = "([{}])",
            Me = {atom: !0, number: !0, variable: !0, string: !0, regexp: !0, "this": !0, "jsonld-keyword": !0},
            Le = {state: null, column: null, marked: null, cc: null}, Ee = {name: "this", next: {name: "arguments"}};
        return y.lex = !0, {
            startState: function (e) {
                var t = {
                    tokenize: o,
            ...
            indent: function (t, n) {
                ...
                var i = n && n.charAt(0), a = t.lexical;
                if (!/^\s*else\b/.test(n)) for (var l = t.cc.length - 1; l >= 0; --l) {
                    var c = t.cc[l];
                    if (c == y) a = a.prev; else if (c != Z) break
                }
    ...
    e.defineMode("htmlmixed", function (t, r) {
        ...
        function i(e, t, r) {
            var n, i = e.current(), o = i.search(t);
        ...
        }), l = e.getMode(t, "css"), c = [], u = r && r.scriptTypes;
        if (c.push({
        ...
        return c.push({matches: /./, mode: e.getMode(t, "text/plain")}), {
            startState: function () {
                ...
                return {token: t.token, localMode: t.localMode, localState: r, htmlState: e.copyState(s, t.htmlState)}
            }, token: function (e, t) {
                return t.token(e, t)
            }, indent: function (t, r) {
    ...
    e.defineMode("gfm", function (t, r) {
        ...
        }, a = {underscoresBreakWords: !1, taskLists: !0, fencedCodeBlocks: !0, strikethrough: !0};
    ...
    e.defineMode("go", function (e) {
        ...
        return {
            startState: function (e) {
                ...
                var n = e.context, i = r && r.charAt(0);
    ...
    var r = "this super static final const abstract class extends external factory implements get native operator set typedef with enum throw rethrow assert break case continue default in return new deferred async await try catch finally do else for if switch while import library export part of show hide is".split(" "),
        n = "try catch finally do else for if switch while".split(" "), i = "true false null".split(" "),
    ...
    e.defineMode("coffeescript", function (e, t) {
        ...
        function a(t, r, n) {
            n = n || "coffee";
            for (var i = 0, o = !1, a = null, s = r.scope; s; s = s.prev) if ("coffee" === s.type || "}" == s.type) {
        ...
        p = r(p);
        var b = /^('{3}|\"{3}|['\"])/, y = /^(\/{3}|\/)/,
            x = ["Infinity", "NaN", "undefined", "null", "true", "false", "on", "off", "yes", "no"], k = r(x), w = {
                startState: function (e) {
                    return {
                        tokenize: n,
                    ...
                    var r = e.scope, i = t && "])}".indexOf(t.charAt(0)) > -1;
    ...
    e.defineMode("nginx", function (e) {
        ...
        return {
            startState: function (e) {
                ...
                if (e.eatSpace()) return null;
                s = null;
                var r = t.tokenize(e, t), n = t.stack[t.stack.length - 1];
    ...
    e.registerHelper("hintWords", "python", i.concat(o)), e.defineMode("python", function (l, c) {
        ...
        var g = "error", v = c.singleDelimiters || new RegExp("^[\\(\\)\\[\\]\\{\\}@,:`=;\\.]"),
        ...
        if (c.version && 3 == parseInt(c.version, 10)) var k = c.singleOperators || new RegExp("^[\\+\\-\\*/%&|\\^~<>!@]"),
            w = c.identifiers || new RegExp("^[_A-Za-z¡-￿][_A-Za-z0-9¡-￿]*"); else var k = c.singleOperators || new RegExp("^[\\+\\-\\*/%&|\\^~<>!]"),
            w = c.identifiers || new RegExp("^[_A-Za-z][_A-Za-z0-9]*");
        var _ = c.hangingIndent || l.indentUnit, C = i, S = o;
        ...
        var M = t(C), L = t(S), E = {
            startState: function (e) {
                ...
                var i = r(t), o = n && n.charAt(0) == i.type;
    ...
    function n(e, t) {
        var r = e.string.length, n = r - e.pos + 1;
    ...
    e.defineMode("lua", function (e, t) {
        ...
        function a(e, t) {
            return function (r, n) {
                for (var i, a = null; null != (i = r.next());) if (null == a) "]" == i && (a = 0); else if ("=" == i) ++a; else {
                    if ("]" == i && a == e) {
                        n.cur = o;
                        break
                    }
        ...
        var l = e.indentUnit, c = n(t.specials || []),
            ...
            f = n(["function", "if", "repeat", "do", "\\(", "{"]), m = n(["end", "until", "\\)", "}"]),
    ...
    e.defineMode("r", function (e) {
        ...
        var a, s = t("NULL NA Inf NaN NA_integer_ NA_real_ NA_complex_ NA_character_"),
            ...
            c = t("if else repeat while function for in next break"), u = t("if else repeat while function for"),
            d = /[+\-*\/^<>=!&|~$:]/;
        return {
            startState: function () {
                return {tokenize: r, ctx: {type: "top", indent: -e.indentUnit, align: !1}, indent: 0, afterIdent: !1}
            }, token: function (e, t) {
                ...
                var i = n && n.charAt(0), o = t.ctx, a = i == o.type;
    ...
    e.defineMode("ruby", function (e) {
        ...
        return {
            startState: function () {
                ...
                var i = r && r.charAt(0), o = t.context,
    ...
    e.defineMode("rst", function (t, r) {
        var n = /^\*\*[^\*\s](?:[^\*]*[^\*\s])?\*\*/, i = /^\*[^\*\s](?:[^\*]*[^\*\s])?\*/,
            o = /^``[^`\s](?:[^`]*[^`\s])``/, a = /^(?:[\d]+(?:[\.,]\d+)*)/, s = /^(?:\s\+[\d]+(?:[\.,]\d+)*)/,
            l = /^(?:\s\-[\d]+(?:[\.,]\d+)*)/, c = "[Hh][Tt][Tt][Pp][Ss]?://", u = "(?:[\\d\\w.-]+)\\.(?:\\w{2,6})",
            d = "(?:/[\\d\\w\\#\\%\\&\\-\\.\\,\\/\\:\\=\\?\\~]+)*", f = new RegExp("^" + c + u + d), m = {
                token: function (e) {
        ...
        function n(t, r) {
            ...
            if (t.sol() && t.match(X, !1)) u(r, l, {
            ...
            }); else if (t.sol() && t.match(T)) u(r, i), o = "meta"; else if (t.sol() && t.match(S)) u(r, n), o = "header"; else if (f(r) == $ || t.match($, !1)) switch (d(r)) {
                case 0:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    if (r.tmp_stex && (r.tmp_stex = void 0, r.tmp = {mode: h, local: e.startState(h)}), r.tmp) {
                        if ("`" == t.peek()) {
                ...
                default:
                    u(r, n)
            } else if (t.match(I)) u(r, n), o = "quote"; else if (t.match(P)) u(r, n), o = "quote"; else if (t.match(D)) u(r, n), (!t.peek() || t.peek().match(/^\W$/)) && (o = "link"); else if (f(r) == A || t.match(A, !1)) switch (d(r)) {
                case 0:
        ...
        var m = e.getMode(t, "python"), h = e.getMode(t, "stex"), p = "\\s+", g = "(?:\\s*|\\W|$)",
            v = new RegExp(r("^{0}", g)), b = "(?:[^\\W\\d_](?:[\\w!\"#$%&'()\\*\\+,\\-\\./:;<=>\\?]*[^\\W_])?)",
            y = new RegExp(r("^{0}", b)), x = "(?:[^\\W\\d_](?:[\\w\\s!\"#$%&'()\\*\\+,\\-\\./:;<=>\\?]*[^\\W_])?)",
            k = r("(?:{0}|`{1}`)", b, x), w = "(?:[^\\s\\|](?:[^\\|]*[^\\s\\|])?)", _ = "(?:[^\\`]+)",
            C = new RegExp(r("^{0}", _)), S = new RegExp("^([!'#$%&\"()*+,-./:;<=>?@\\[\\\\\\]^_`{|}~])\\1{3,}\\s*$"),
            T = new RegExp(r("^\\.\\.{0}", p)), M = new RegExp(r("^_{0}:{1}|^__:{1}", k, g)),
            L = new RegExp(r("^{0}::{1}", k, g)), E = new RegExp(r("^\\|{0}\\|{1}{2}::{3}", w, p, k, g)),
            q = new RegExp(r("^\\[(?:\\d+|#{0}?|\\*)]{1}", k, g)), j = new RegExp(r("^\\[{0}\\]{1}", k, g)),
            z = new RegExp(r("^\\|{0}\\|", w)), I = new RegExp(r("^\\[(?:\\d+|#{0}?|\\*)]_", k)),
            P = new RegExp(r("^\\[{0}\\]_", k)), D = new RegExp(r("^{0}__?", k)), A = new RegExp(r("^`{0}`_", _)),
            $ = new RegExp(r("^:{0}:`{1}`{2}", b, _, g)), O = new RegExp(r("^`{1}`:{0}:{2}", b, _, g)),
            R = new RegExp(r("^:{0}:{1}", b, g)), F = new RegExp(r("^{0}", k)), H = new RegExp(r("^::{0}", g)),
            N = new RegExp(r("^\\|{0}\\|", w)), B = new RegExp(r("^{0}", p)), U = new RegExp(r("^{0}", k)),
            W = new RegExp(r("^::{0}", g)), V = new RegExp("^_"), K = new RegExp(r("^{0}|_", k)),
            Z = new RegExp(r("^:{0}", g)), G = new RegExp("^::\\s*$"), X = new RegExp("^\\s+(?:>>>|In \\[\\d+\\]:)\\s");
        return {
            startState: function () {
                return {tok: n, ctx: c(void 0, 0)}
            }, copyState: function (t) {
                var r = t.ctx, n = t.tmp;
                return r.local && (r = {mode: r.mode, local: e.copyState(r.mode, r.local)}), n && (n = {
                    mode: n.mode,
                    local: e.copyState(n.mode, n.local)
                }), {tok: t.tok, ctx: r, tmp: n}
            }, innerMode: function (e) {
                return e.tmp ? {state: e.tmp.local, mode: e.tmp.mode} : e.ctx.mode ? {
                    state: e.ctx.local,
                    mode: e.ctx.mode
                } : null
            }, token: function (e, t) {
    ...
    e.defineMode("smartymixed", function (t) {
        ...
        var n = e.getMode(t, "htmlmixed"), i = e.getMode(t, "smarty"), o = {rightDelimiter: "}", leftDelimiter: "{"};
        ...
        var a = r(o.leftDelimiter), s = r(o.rightDelimiter), l = {
        ...
        return {
            startState: function () {
                ...
                var r = null, o = t.tokenize || t.token;
    ...
    e.defineMode("vb", function (e, t) {
        ...
        function s(e, t) {
            var r = t.tokenize(e, t), o = e.current();
        ...
        var l = "error", c = new RegExp("^[\\+\\-\\*/%&\\\\|\\^~<>!]"),
            u = new RegExp("^[\\(\\)\\[\\]\\{\\}@,:`=;\\.]"),
            d = new RegExp("^((==)|(<>)|(<=)|(>=)|(<>)|(<<)|(>>)|(//)|(\\*\\*))"),
            f = new RegExp("^((\\+=)|(\\-=)|(\\*=)|(%=)|(/=)|(&=)|(\\|=)|(\\^=))"),
            m = new RegExp("^((//=)|(>>=)|(<<=)|(\\*\\*=))"), h = new RegExp("^[_A-Za-z][_A-Za-z0-9]*"),
            p = ["class", "module", "sub", "enum", "select", "while", "if", "function", "get", "set", "property", "try"],
            g = ["else", "elseif", "case", "catch"], v = ["next", "loop"], b = r(["and", "or", "not", "xor", "in"]),
            ...
            x = ["integer", "string", "double", "decimal", "boolean", "short", "char", "float", "single"], k = r(y),
            w = r(x), _ = '"', C = r(p), S = r(g), T = r(v), M = r(["end"]), L = r(["do"]), E = null, q = {
                electricChars: "dDpPtTfFeE ", startState: function () {
                    return {tokenize: o, lastToken: null, currentIndent: 0, nextLineIndent: 0, doInCurrentLine: !1}
                }, token: function (e, t) {
    ...
    e.defineMode("vbscript", function (e, t) {
        ...
        var l = "error", c = new RegExp("^[\\+\\-\\*/&\\\\\\^<>=]"), u = new RegExp("^((<>)|(<=)|(>=))"),
            d = new RegExp("^[\\.,]"), f = new RegExp("^[\\(\\)]"), m = new RegExp("^[A-Za-z][_A-Za-z0-9]*"),
            h = ["class", "sub", "select", "while", "if", "function", "property", "with", "for"],
            p = ["else", "elseif", "case"], g = ["next", "loop", "wend"],
        ...
        var E = r(b), q = r(y), j = r(x), z = r(w), I = r(L), P = '"', D = r(h), A = r(p), $ = r(g), O = r(["end"]),
            R = r(["do"]), F = r(["on error resume next", "exit"]), H = r(["rem"]), N = {
                electricChars: "dDpPtTfFeE ", startState: function () {
                    return {
                        tokenize: o,
                        lastToken: null,
                    ...
                    e.sol() && (t.currentIndent += t.nextLineIndent, t.nextLineIndent = 0, t.doInCurrentLine = 0);
                    var r = s(e, t);
                    return t.lastToken = {style: r, content: e.current()}, "space" === r && (r = null), r
                }, indent: function (t, r) {
                    var n = r.replace(/^\s+|\s+$/g, "");
    ...
    e.defineMode("velocity", function () {
        ...
        return {
            startState: function () {
                return {tokenize: r, beforeParams: !1, inParams: !1, inString: !1, lastTokenWasBuiltin: !1}
            }, token: function (e, t) {
    ...
    e.defineMode("xquery", function () {
        ...
        function r(r, s) {
            ...
            if (g || '"' !== f && "'" !== f) {
                ...
                return _ = k.propertyIsEnumerable(S) && k[S], h && !_ && (_ = {
                    type: "function_call",
                    style: "variable def"
                }), m(s) ? (b(s), e("word", "variable", S)) : (("element" == S || "attribute" == S || "axis_specifier" == _.type) && v(s, {type: "xmlconstructor"}), _ ? e(_.type, _.style, S) : e("word", "variable", S))
            }
            return t(r, s, i(f))
        }
        ...
        function l(t, n) {
            for (var i; i = t.next();) if ("-" == i && t.match("->", !0)) return n.tokenize = r, e("comment", "comment")
        }
        ...
        function u(t, n) {
            for (var i; i = t.next();) if ("?" == i && t.match(">", !0)) return n.tokenize = r, e("comment", "comment meta")
        }
        ...
        var y, x, k = function () {
            ...
            for (var t = e("keyword a"), r = e("keyword b"), n = e("keyword c"), i = e("operator"), o = {
                type: "atom",
                style: "atom"
            }, a = {type: "punctuation", style: null}, s = {type: "axis_specifier", style: "qualifier"}, l = {
                "if": t,
                "switch": t,
                "while": t,
                "for": t,
    ...
    e.defineMIME("text/x-erlang", "erlang"), e.defineMode("erlang", function (t) {
        ...
        function h(e, t) {
            var r = e.tokenStack.length, n = t ? t : 1;
        ...
        function b(e, t) {
            for (var r in t) for (var n = e.length - 1, i = t[r], o = n - 1; o > -1; o--) if (c(e[o].token, i)) {
                var a = e.slice(0, o);
                switch (r) {
                    case"m":
        ...
        function y(r, n) {
            var i, o = t.indentUnit, a = x(n), s = h(r, 1), l = h(r, 2);
        ...
        function k(e) {
            var t = e.tokenStack.slice(0, -1), r = C(t, "type", ["open_paren"]);
            return S(t[r]) ? t[r] : !1
        }

        function w(e) {
            var t = e.tokenStack, r = C(t, "type", ["open_paren", "separator", "keyword"]),
                n = C(t, "type", ["operator"]);
            return S(r) && S(n) && n > r ? t[r + 1] : S(r) ? t[r] : !1
        }

        function _(e, t) {
            var r = e.tokenStack, n = C(r, "token", t);
        ...
        var T = ["-type", "-spec", "-export_type", "-opaque"],
            ...
            R = /[\w@Ø-ÞÀ-Öß-öø-ÿ]/, F = /[0-7]{1,3}|[bdefnrstv\\"']|\^[a-zA-Z]|x[0-9a-zA-Z]{2}|x{[0-9a-zA-Z]+}/;
        return {
            startState: function () {
    ...
    e.defineMode("jade", function (t) {
        ...
        function C(e, t) {
            if (t.isEach) {
                ...
                if (e.sol() || e.eol()) t.isEach = !1; else if (e.next()) {
        ...
        function z(e, t) {
            if (t.isAttrs) {
                if (X[e.peek()] && t.attrsNest.push(X[e.peek()]), t.attrsNest[t.attrsNest.length - 1] === e.peek()) t.attrsNest.pop(); else if (e.eat(")")) return t.isAttrs = !1, "punctuation";
        ...
        var V = "keyword", K = "meta", Z = "builtin", G = "qualifier", X = {"{": "}", "(": ")", "[": "]"},
